...
class Block:
    def __init__(self, previous_block_hash, global_model, worker_to_uw, produced_by, worker_to_model_sig, validator_txs, validator_rsa_pub_key):
        self.previous_block_hash = previous_block_hash
        self.global_model = global_model
        self.worker_to_uw = worker_to_uw
        # validator specific
